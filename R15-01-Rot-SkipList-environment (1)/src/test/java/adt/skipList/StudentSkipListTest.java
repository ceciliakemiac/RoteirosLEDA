...
public class StudentSkipListTest {
	...
	public void testSearch() {
		...
		assertEquals("A", skip.searchR(10).getValue());
		assertEquals("B", skip.searchR(20).getValue());
		assertEquals("C", skip.searchR(0).getValue());
		assertEquals("D", skip.searchR(15).getValue());
		assertEquals("E", skip.searchR(5).getValue());

		assertEquals(null, skip.searchR(-10));
		assertEquals(null, skip.searchR(30));
		assertEquals(null, skip.searchR(9));
	}
